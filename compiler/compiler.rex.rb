  ...
  def scan_evaluate( str )
    ...
    until ss.eos?
      ...
      when nil
        ...
        when (text = ss.scan(/<</))
           @rex_tokens.push action { [:LEFT_BIT_SHIFT, text] }

        when (text = ss.scan(/>>/))
           @rex_tokens.push action { [:RIGHT_BIT_SHIFT, text] }
        ...
        when (text = ss.scan(///))
           @rex_tokens.push action { [:DIVIDE, text] }
        ...
        when (text = ss.scan(/</))
           @rex_tokens.push action { [:LESS, text] }
